...
constructors.set('CommandPalette', () => new CommandPaletteAbject());
constructors.set('NotificationCenter', () => new NotificationCenter());
...
constructors.set('ChatBrowser', () => new ChatBrowser());
...
constructors.set('ExternalProjectRegistry', () => new ExternalProjectRegistry());
constructors.set('ExternalCreator', () => new ExternalCreator());
constructors.set('ExternalProjectBrowser', () => new ExternalProjectBrowser());
